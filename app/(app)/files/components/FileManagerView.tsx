...
/**
 * Reusable file manager. Rendered inside the Documents module as the "Files"
 * view (?view=files) while keeping the legacy /files deep link working via
 * a ViewRedirect.
 */
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-2">
        <p className="text-sm text-muted-foreground">
          Upload, preview, and manage your files — they stay attached to your
      ...
      >
        {dragOver && (
          <div className="mb-4 flex items-center justify-center rounded-xl border-2 border-dashed border-[color:var(--primary)] bg-primary-soft py-12">
            <div className="flex flex-col items-center gap-2 text-[color:var(--primary)]">
